...
class ThemeSettingsManager
{
    ...
    private $checkbox_settings = [
        ...
        'usedropdown',
        'useloginbgmask',
        'benefitsbuttonurlopennew',
        'homeblockbuttonurlopennew',
        'homeblock1urlopennew',
        'homeblock2urlopennew',
        'homeblock3urlopennew',
        'homeblock4urlopennew',
        'homeblock5urlopennew',
        'homeblock6urlopennew',
        'homeblock7urlopennew',
        'homeblock8urlopennew',
        'homeblock9urlopennew',
        'homeblock10urlopennew',
        'homeblock11urlopennew',
        'homeblock12urlopennew',
        'homeblock13urlopennew',
        'homeblock14urlopennew',
        'homeblock15urlopennew',
        'homeblock16urlopennew',
        'homeblock17urlopennew',
        'homeblock18urlopennew',
        'homeblock19urlopennew',
        'homeblock20urlopennew',

        'carouselitem1buttonurlopennew',
        'usecarouselitem1video',
        'carouselitem2buttonurlopennew',
        'usecarouselitem2video',
        'carouselitem3buttonurlopennew',
        'usecarouselitem3video',
        'carouselitem4buttonurlopennew',
        'usecarouselitem4video',
        'carouselitem5buttonurlopennew',
        'usecarouselitem5video',
        'carouselitem6buttonurlopennew',
        'usecarouselitem6video',
        'carouselitem1buttonurlopennew',
        'usecarouselitem1video',
        'carouselitem2buttonurlopennew',
        ...
        'carouselitem6buttonurlopennew',
        'usecarouselitem6video',
        'categoriesbuttonurlopennew',
        'teachersbuttonurlopennew',
        'testimonialsbuttonurlopennew',
        'faqsectionbuttonurlopennew',
        'ctasectionbuttonurlopennew',
        'usectadatabox',
        'usecoursesummarytrim',
        'usecourseheaderimage',
        'hasinternet'
    ...
    private $dropdown_settings = [
        'preset' => [
            'theme-1.scss' => 'Theme 1',
            'theme-2.scss' => 'Theme 2',
            'theme-3.scss' => 'Theme 3',
            'theme-4.scss' => 'Theme 4',
            'theme-5.scss' => 'Theme 5',
            'theme-6.scss' => 'Theme 6',
        ],
        'pagefont' => [
            'Roboto' => 'Roboto',
        ...
        'carouselitem1videoswitcher' => [
            '1' => 'YouTube Video',
            '2' => 'Vimeo Video'
        ],
        'carouselitem2videoswitcher' => [
            '1' => 'YouTube Video',
            '2' => 'Vimeo Video'
        ],
        'carouselitem3videoswitcher' => [
            '1' => 'YouTube Video',
            '2' => 'Vimeo Video'
        ],
        'carouselitem4videoswitcher' => [
            '1' => 'YouTube Video',
            '2' => 'Vimeo Video'
        ],
        'carouselitem5videoswitcher' => [
            '1' => 'YouTube Video',
            '2' => 'Vimeo Video'
        ],
        'carouselitem6videoswitcher' => [
            '1' => 'YouTube Video',
            '2' => 'Vimeo Video'
        ],
        'carouselitemheight' => [
